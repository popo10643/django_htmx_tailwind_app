...
def test_party_list_page_returns_list_of_users_future_parties(authenticated_client, create_user, create_party, django_user_model):
    """
    This is a test to check if Returns a subset of the Party objects that match the following criteria:
        - organizer must be the request.user.
        - Past parties should not be displayed.
        - Parties should be returned in order of the party_date.
    """
